 ...
 */
@Service
@Command(scope = "onos", name = "route-gtp4d-insert",
         description = "Insert a t_insert rule into the IPv4 Routing table")
public class GTP4DRouteInsertCommand extends AbstractShellCommand {
   ...
   @Argument(index = 0, name = "uri", description = "Device ID",
    ...
    protected void doExecute() {
        ...
        app.insertGTP4DRoutingRule(device.id(), ipv4Addr, mask, src_addr, s1);
