...
public class Ipv6RoutingComponent {
    ...
    public void insertV4RoutingRule(DeviceId routerId, Ip4Address ipv4Addr,
                                    int mask, MacAddress nextHopMac) {
        log.info("Adding a route on {}...", routerId);

        final String tableId = "IngressPipeImpl.routing_v4";
        final String actionName = "IngressPipeImpl.routing_v4";
    ...
    public void insertGTP4DRoutingRule(DeviceId routerId, Ip4Address ipv4Addr, 
                                    int mask,  Ip6Address src_addr, Ip6Address s1 ) {
        log.info("Adding a route on {}...", routerId);

        final String tableId = "IngressPipeImpl.srv6_transit_udp";
        final String actionName = "IngressPipeImpl.srv6_transit_udp";

        final PiCriterion match = PiCriterion.builder()
                // .matchLpm(
                //         PiMatchFieldId.of("hdr.inner_ipv4.dst_addr"),
                //         ipv4Addr.toOctets(),
                //         mask)
                .matchExact(
                        PiMatchFieldId.of("hdr.udp.dst_port"), 2152)
                .build();

        final PiAction action = PiAction.builder()
                    .withId(PiActionId.of("IngressPipeImpl.t_m_gtp4_d_sid1"))
                    .withParameter(new PiActionParam(
                            // Action param name.
     ...
     public void insertGTP4ERoutingRule(DeviceId routerId, Ip4Address ipv4SrcAddress, 
                                     Ip4Address ipv4DstAddress, Ip6Address ipv6netAddress, int teid ) {
        log.info("Adding a route on {}...", routerId);

        final String tableId = "IngressPipeImpl.srv6_localsid_table";
      
        final String actionName = "IngressPipeImpl.srv6_gtp4_e";

        final PiCriterion match = PiCriterion.builder()
                .matchLpm(
                        PiMatchFieldId.of("hdr.ipv6.dst_addr"),
                        ipv6netAddress.toOctets(), 64)
                .build();


        final PiAction action = PiAction.builder()
                    .withId(PiActionId.of("IngressPipeImpl.srv6_gtp4_e"))
                    .withParameter(new PiActionParam(
                            // Action param name.
                            PiActionParamId.of("src_addr"),
                            // Action param value.
                            ipv4SrcAddress.toOctets()))
                    .withParameter(new PiActionParam(
                                // Action param name.
                            PiActionParamId.of("dst_addr"),
                                // Action param value.
                            ipv4DstAddress.toOctets()))
                    .withParameter(new PiActionParam(
                                // Action param name.
                            PiActionParamId.of("teid"),
                                // Action param value.
                            teid)) 
                    .build();
    ...
    public void insertEnSRv6V4Rule(DeviceId routerId, Ip4Address ipv4Addr, 
                                    int mask,  int dscp, Ip6Address src_addr, Ip6Address s1 ) {
        log.info("Adding a route on {}...", routerId);

        final String tableId = "IngressPipeImpl.srv6_encap_v4";
        final String actionName = "IngressPipeImpl.srv6_encap_v4";
        ...
        final PiCriterion match = PiCriterion.builder()
                .matchLpm(
                        ...
                        mask)
                .matchExact(
                        PiMatchFieldId.of("hdr.ipv4.dscp"), dscp)
                .build();

        final PiAction action = PiAction.builder()
                    .withId(PiActionId.of("IngressPipeImpl.usid_encap_1_v4"))
                    .withParameter(new PiActionParam(
                            // Action param name.
                            PiActionParamId.of("src_addr"),
                            // Action param value.
