...
```
 ...
 |    worker 2    |  10.100.200.3 (eno0)            10.100.200.4 (br0)|                | 192.168.0.4 (br1)     192.168.0.3 (eno0)|   worker 3     |                  |
 |    (UE, gNB)   |*-------------------------------------------------*|     mininet    |*---------------------------------------*|  (UPF, k8s)    |                  |
 |________________|                                                   |________________|                                         |________________|                  |
                                                                               * 192.168.1.4 (br2)                                                                   |
                                                                               |                                                                                     |
                                                                               |                                                  ________________                   |
                                                                               |                               192.168.1.3 (eno0)|    worker 1    |                  |
                                                                               |------------------------------------------------*|     (k8s)      |*-----------------|
...
```
ovs-vsctl show
ovs-ofctl add-flow br0 in_port=enxf8e43b4d17e5,actions=output:v_eth1
ovs-ofctl add-flow br0 in_port=v_eth1,actions=output:enxf8e43b4d17e5
